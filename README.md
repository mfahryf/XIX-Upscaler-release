...
`.sig`, `latest.json`, dan alias stabil `Upscaler-latest-x64-setup.exe`, yang
dipakai halaman publik Upscaler dan updater aplikasi.

Release terverifikasi saat ini: `v0.1.3`.

- Metadata updater: `https://github.com/mfahryf/XIX-Upscaler-release/releases/latest/download/latest.json`
- Installer stabil: `https://github.com/mfahryf/XIX-Upscaler-release/releases/latest/download/Upscaler-latest-x64-setup.exe`

Alur release:

1. Selaraskan perubahan dari repository sumber `mfahryf/XIX-Upscaler`.
